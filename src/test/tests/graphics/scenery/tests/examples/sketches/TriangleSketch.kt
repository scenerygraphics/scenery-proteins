...
/**
 * This class should create a triangular form along a curve, so that the thickness gets
 * smaller with the length of the curve.
 */
class TriangleSketch: SceneryBase("TriangleSketch", windowWidth = 1280, windowHeight = 720) {
    ...
    override fun init() {
        ...
        fun triangular(begThick: Float, endThick: Float, n: Int): ArrayList<GLVector> {
